...
//			List<TaskInfo> taskinfos = parser.getTaskInfoByGroupName(groupName);
//			
//			JsonObject obj = new JsonObject();
//			obj.addProperty("taskgroupname", groupName);
//			JsonArray tasks = new JsonArray();
//			for(Iterator<TaskInfo> taskIt = taskinfos.iterator(); taskIt.hasNext();) {
//				TaskInfo info = taskIt.next();
//				JsonObject iObj = new JsonObject();
//				iObj.addProperty("taskname", info.getTaskName());
